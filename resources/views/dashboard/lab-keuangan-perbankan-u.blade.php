...
<head>
    ...
    <title>lab keuangan dan perbankan</title>
...
<body>
        ...
        <div class="calendar">
            <div class="calendar-top-section">
                ...
                <div class="header-content">
                    ...
                    <div class="header-title">Laboratorium Ilmu Keuangan Perbankan</div>
                </div>
            </div>
    ...
    <script>
        ...
        document.getElementById('bookingForm').addEventListener('submit', function(e) {
            ...
            const formattedDate = document.getElementById('confirmDate').textContent;
            document.getElementById('confirmTime').textContent = `Waktu: ${timeSlot}`;
            document.getElementById('confirmName').textContent = `Atas nama: ${name}`;
