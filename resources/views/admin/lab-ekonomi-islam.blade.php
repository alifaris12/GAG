...
<head>
    ...
    <title>Kelola Booking Lab Ekonomi Islam - Admin</title>
    ...
    <div class="main-container">
        ...
        <div class="header-card">
            <h1 class="header-title">
                ...
                Kelola Booking Laboratorium Ekonomi Islam
            </h1>
        </div>
        ...
        <div class="content-card">
            ...
            <div class="filter-buttons">
                <a href="{{ route('lab-ekonomi-islam') }}" class="filter-btn {{ !request('status') ? 'active' : '' }}">
                    <i class="fas fa-list"></i> Semua ({{ App\Models\BookingLaboratoriumEkonomiIslam::count() }})
                </a>
                <a href="{{ route('lab-ekonomi-islam', ['status' => 'pending']) }}" class="filter-btn {{ request('status') === 'pending' ? 'active' : '' }}">
                    <i class="fas fa-clock"></i> Pending
                </a>
                <a href="{{ route('lab-ekonomi-islam', ['status' => 'approved']) }}" class="filter-btn {{ request('status') === 'approved' ? 'active' : '' }}">
                    <i class="fas fa-check"></i> Approved
                </a>
                <a href="{{ route('lab-ekonomi-islam', ['status' => 'rejected']) }}" class="filter-btn {{ request('status') === 'rejected' ? 'active' : '' }}">
                        ...
                        <tr>
                            ...
                            <td>
                                <div style="display: flex; gap: 5px;">
                                    @if($booking->status === 'pending')
                                        <!-- Approve Button -->
                                        <form action="{{ route('lab-ekonomi-islam.approve', $booking->id) }}" method="POST" style="display: inline;">
                                            @csrf
                                        ...
                                        <!-- Reject Button -->
                                        <form action="{{ route('lab-ekonomi-islam.reject', $booking->id) }}" method="POST" style="display: inline;">
                                            @csrf
                                    ...
                                    <!-- Delete Button -->
                                    <form action="{{ route('lab-ekonomi-islam.destroy', $booking->id) }}" method="POST" style="display: inline;" onsubmit="return confirm('Yakin ingin menghapus booking ini?')">
                                        @csrf
                                        @method('DELETE')
